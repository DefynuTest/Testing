...
<c:otherwise>
   <li><a href="/signout" class="login">Signout</a></li>
	 ...
	 <section class="blog text-center" >
		...
		<div  id="form-btn">
		<br><br>
		<form align="right" action="/change?body=${shirt}&outercollar=${OuterCollar}&innercollar=${InnerCollar}&outercuff=${OuterCuff}&innercuff=${InnerCuff}&button=${Button}&buttonplacket=${ButtonPlacket}&outsidefastening=${OutsideFastening}&price=${Price}&pocket=${Pocket}" method="post" target="_self">

  <input type="submit" style="background-color:#000"  class="btn btn-primary btn-sm" value="CHANGE"> 
</form>

<form align="right" action="/continueshopping?body=${shirt}&outercollar=${OuterCollar}&innercollar=${InnerCollar}&outercuff=${OuterCuff}&innercuff=${InnerCuff}&button=${Button}&buttonplacket=1&outsidefastening=${OutsideFastening}" method="post" target="_self">
...
<form align="right" action="/checkout" method="GET" target="_self">
          ...
          <form role="form" action="/register" method="post">
            ...
            <div class="form-group">
              ...
              <input type="password" class="form-control" id="psw" placeholder="Enter password">
               ...
               <button  type="button" onclick="loadDoc('/register?')" id="openBtn" data-toggle="modal"  data-target="#myModal2" class="btn btn-success btn-block"><span class="glyphicon glyphicon-off" ></span> Sign UP</button>
  ...
  <div class="modal fade" id="myModal2" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style="padding:40px 50px;">
          <form role="form" action="/verifyOTP?" method="POST">
  ...
  -->
  <button type="button" onclick="loadDoc1('/verifyOTP?')" class="btn  btn-default pull-left" ><span class="glyphicon glyphicon-google"></span>Verify</button>
          </form>
        </div>
        <div class="modal-footer" >
          <button type="submit" class="btn  btn-default pull-left" data-dismiss="modal"><span class="glyphicon glyphicon-google"></span> Cancel</button>
  ...
  <div class="modal fade" id="myModal4" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style="padding:40px 50px;">
          <form role="form" action="/verifyOTP?">
             <div class="form-group">
              <label for="psw"><span class="glyphicon glyphicon-eye-open"></span> OTP</label>
